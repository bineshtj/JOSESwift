...
class HMACTests: RSACryptoTestCase {
    ...
    func testHMACCalculation() {
        let hmacOutput = JoseHMAC.calculate(from: testData, with: testKey, using: .SHA512)
    ...
    func testHMACCalculationWithFalseKey() {
        ...
        let hmacOutput = JoseHMAC.calculate(from: testData, with: falseKey, using: .SHA512)
    ...
    func testHMACCalculationWithFalseData() {
        ...
        let hmacOutput = JoseHMAC.calculate(from: falseData, with: testKey, using: .SHA512)
